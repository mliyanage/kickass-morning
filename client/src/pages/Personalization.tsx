            ...
            <Card className="overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800">
                  {hasExistingData ? "Update Your Wakeup Preferences" : "Personalize Your Wakeup Experience"}
                </h2>
                <p className="mt-1 text-sm text-gray-500">
                  {hasExistingData ? "Make changes to your personalization settings" : "Customize your wakeup call for better motivation"}
                </p>
              </div>
