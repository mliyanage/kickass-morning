...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:sticky lg:top-10 lg:self-start">
        ...
        <a
          href="#"
          className={`${isActive("/call-history") ? "bg-gray-50 text-primary" : "text-gray-700 hover:text-primary hover:bg-gray-50"} group rounded-md px-3 py-2 flex items-center text-sm font-medium`}
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`${isActive("/call-history") ? "text-primary" : "text-gray-400 group-hover:text-primary"} mr-3 flex-shrink-0 h-6 w-6`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-white/20 shadow-lg z-50">
        <nav className="flex justify-around items-center py-2 px-4">
          <a
            href="#"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] ${isActive("/dashboard") ? "text-primary" : "text-gray-500"}`}
            onClick={(e) => {
              e.preventDefault();
              setLocation("/dashboard");
            }}
          ...
          <a
            href="#"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] ${isActive("/personalization") ? "text-primary" : "text-gray-500"}`}
            onClick={(e) => {
              e.preventDefault();
              setLocation("/personalization");
            }}
          ...
          <a
            href="#"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] ${isActive("/schedule-call") ? "text-primary" : "text-gray-500"}`}
            onClick={(e) => {
              e.preventDefault();
              setLocation("/schedule-call");
            }}
          ...
          <a
            href="#"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] ${isActive("/call-history") ? "text-primary" : "text-gray-500"}`}
            onClick={(e) => {
              e.preventDefault();
              setLocation("/call-history");
            }}
