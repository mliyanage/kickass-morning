...
const isConfigured = !!ELEVENLABS_API_KEY && ELEVENLABS_API_KEY !== 'dummy_key_for_development';
...
export async function textToSpeech(
  ...
  try {
    ...
    if (!isConfigured) {
      log('Using mock ElevenLabs text-to-speech due to missing API key', 'elevenlabs');
    ...
    log(`Converting text to speech with ElevenLabs voice: ${elevenLabsVoiceId}`, 'elevenlabs');
